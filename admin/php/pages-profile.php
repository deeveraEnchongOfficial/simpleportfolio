...
$query = "SELECT * FROM profile,admin_users";
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="javascript:void(0)"><i class="ti-user me-1 ms-1"></i>
                                    My Profile</a>
                                <a class="dropdown-item" href="logout.php"><i class="ti-wallet me-1 ms-1"></i>
                                    Logout</a>
                            </ul>
                        </li>
                        <!-- ============================================================== -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="mt-4"> <img src="../assets/images/users/5.jpg"
                                    ...
                                    <h4 class="card-title mt-2">Enchong</h4>
                    ...
                    <div class="col-lg-8 col-xlg-9">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="uprofile.php" class="form-horizontal form-material mx-2">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Proffesion</label>
                                        <div class="col-md-12">
                                            <input type="text" name="Proffesion" value="<?=$data['Proffesion']?>" placeholder="<?=$data['Proffesion']?>"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email" name="Email" value="<?=$data['user_id']?>" placeholder="<?=$data['user_id']?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="password" name="Password" value="<?=$data['user_pass']?>"
                                                class="form-control form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="AboutMe" placeholder="About Me" rows="2"><?=$data['About Me']?></textarea>
                                    </div>
                        
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button type="submit" name="uprofile" class="btn btn-success text-white">Update Profile</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
